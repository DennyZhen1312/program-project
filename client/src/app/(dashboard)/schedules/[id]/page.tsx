...
export default async function Schedule({ params }: Props) {
  ...
  console.log("formattedAvailabilities",formattedAvailabilities.map(a=>a.formattedStartDate))
  return (
    <div>
      <DatePickerWithRange
        ...
        // @ts-ignore
      />
      <Scheduler from={startDate} to={endDate} userSchedules={userSchedules} availabilities={availabilities} formattedStartDate={formattedAvailabilities}/>
    </div>
  );
}
